...
export const LoginForm = ({ className, ...props }: React.ComponentProps<"div">) =>
{
    ...
    useEffect(() => { isAuthenticatedUser && navigate("/"); }, [isAuthenticatedUser, navigate]);
            ...
            <Card className="overflow-hidden">
                <CardContent className="grid p-0 md:grid-cols-2">
                    <form onSubmit={handleLogin} className="p-6 md:p-8 flex flex-col gap-6">
                        ...
                        <div className="grid grid-cols-3 gap-4">
                            ...
                            <Button variant="outline" className="w-full">
                                ...
                                <span className="sr-only">Login with Google</span></Button>
                            <Button variant="outline" className="w-full">
                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
                                    <path
                    ...
                    <div className="relative hidden bg-muted md:block">
                        <img src="photo.jpg" alt="Banner" className="absolute inset-0 h-full w-full object-cover dark:brightness-75 dark:grayscale" />
                    </div>
                </CardContent>
            </Card>
